...
// ============================================================
// This server ONLY handles: user registration, admin panel,
// visitor tracking, and channel management via Supabase.
// It does NOT handle extension AI comments or Kick live checks.
// ============================================================
...
// FIX: Only accept channel, email, discord — matching the Supabase table schema
...
// ===== PUBLIC: GET ALL CHANNELS (for sync) =====
...
app.post("/api/track", async (req, res) => {
  try {
    ...
    // Deduplicate: skip if same IP within 10 seconds
